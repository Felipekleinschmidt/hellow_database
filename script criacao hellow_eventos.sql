...
-- -----------------------------------------------------
-- Table `hellow_eventos`.`fonecerdor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fonecerdor` (
  `id` SMALLINT NOT NULL,
  `nome` VARCHAR(50) NOT NULL,
  ...
  INDEX `fk_fonecerdor_endereco1_idx` (`endereco_id` ASC) ,
  INDEX `fk_fonecerdor_tipo1_idx` (`tipo_id` ASC) ,
  CONSTRAINT `fk_fonecerdor_endereco1`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `hellow_eventos`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fonecerdor_tipo1`
    FOREIGN KEY (`tipo_id`)
    REFERENCES `hellow_eventos`.`tipo` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `hellow_eventos`.`clinte`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`clinte` (
  `id` INT NOT NULL,
  `nome` VARCHAR(30) NOT NULL,
  `sobrenome` VARCHAR(30) NOT NULL,
  `cpf` INT(11) NOT NULL,
  `relefone` INT(11) NOT NULL,
  `email` VARCHAR(50) NULL,
  `endereco_id` SMALLINT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `cpf_UNIQUE` (`cpf` ASC) ,
  INDEX `fk_clinte_endereco1_idx` (`endereco_id` ASC) ,
  CONSTRAINT `fk_clinte_endereco1`
    FOREIGN KEY (`endereco_id`)
    REFERENCES `hellow_eventos`.`endereco` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fk_ingresso_cliente` (
  ...
  `clinte_id` INT NOT NULL,
  PRIMARY KEY (`ingresso_id`, `clinte_id`),
  INDEX `fk_ingresso_has_clinte_clinte1_idx` (`clinte_id` ASC) ,
  INDEX `fk_ingresso_has_clinte_ingresso_idx` (`ingresso_id` ASC) ,
  CONSTRAINT `fk_ingresso_has_clinte_ingresso`
    FOREIGN KEY (`ingresso_id`)
    REFERENCES `hellow_eventos`.`ingresso` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ingresso_has_clinte_clinte1`
    FOREIGN KEY (`clinte_id`)
    REFERENCES `hellow_eventos`.`clinte` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `hellow_eventos`.`fk_fonecerdor_evento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fk_fonecerdor_evento` (
  `fonecerdor_id` SMALLINT NOT NULL,
  `evento_id` SMALLINT NOT NULL,
  PRIMARY KEY (`fonecerdor_id`, `evento_id`),
  INDEX `fk_fonecerdor_has_evento_evento1_idx` (`evento_id` ASC) ,
  INDEX `fk_fonecerdor_has_evento_fonecerdor1_idx` (`fonecerdor_id` ASC) ,
  CONSTRAINT `fk_fonecerdor_has_evento_fonecerdor1`
    FOREIGN KEY (`fonecerdor_id`)
    REFERENCES `hellow_eventos`.`fonecerdor` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_fonecerdor_has_evento_evento1`
    FOREIGN KEY (`evento_id`)
    REFERENCES `hellow_eventos`.`evento` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
